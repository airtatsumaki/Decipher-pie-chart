var nb_sliders = 8; // nb of range sliders
...
// change this to get data from form input box's (seg1 - seg8)
function getData() {
  var json = [];
  d3.selectAll('#rangebox .range').each(function() {
...
function showValues() {
  d3.selectAll('#rangebox .range').each(function() {
    ...
    console.log("this segs data-id is : " + this.getAttribute('data-id'));
    jQuery("#seg" + index).val(this.value);
